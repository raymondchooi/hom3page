...
export interface StINRWLInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface StINRWL extends BaseContract {
  connect(runner?: ContractRunner | null): StINRWL;
  waitForDeployment(): Promise<this>;

  interface: StINRWLInterface;
