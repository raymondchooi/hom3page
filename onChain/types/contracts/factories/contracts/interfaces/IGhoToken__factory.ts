...
import type {
  IGhoToken,
  IGhoTokenInterface,
} from "../../../contracts/interfaces/IGhoToken";
...
export class IGhoToken__factory {
  ...
  static createInterface(): IGhoTokenInterface {
    return new Interface(_abi) as IGhoTokenInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IGhoToken {
    return new Contract(address, _abi, runner) as unknown as IGhoToken;
  }
}
